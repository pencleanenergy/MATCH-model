...
def write_table(instance, *indexes, **kwargs):
    ...
    with open(output_file, "w") as f:
        ...
        try:
            ...
            print(
                "DEPRECATION WARNING: match_model.reporting.write_table() was called with a function"
            )
            print(
                "that expects multidimensional index values to be stored in tuples, but MATCH now unpacks"
            )
            print(
