...
# match_model.hydro.core module, the simplist components into
# match_model.hydro.simple, and the advanced components into
# match_model.hydro.water_network. That should set a good example
...
dependencies = 'match_model.timescales', 'match_model.balancing.load_zones',\
    'match_model.financials', 'match_model.energy_sources.properties.properties', \
