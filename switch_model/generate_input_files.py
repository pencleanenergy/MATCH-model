    ...
    for index,row in vcf_sets.iterrows():
        ...
        for scenario in set_scenario_list:
            ...
            if 'select_variants' in option_list:
                scenarios.write(f'--scenario-name {scenario} --outputs-dir outputs/{scenario} --inputs-dir inputs/{scenario} --select_variants select')
                scenarios.write('\n')
            else:
                scenarios.write(f'--scenario-name {scenario} --outputs-dir outputs/{scenario} --inputs-dir inputs/{scenario}')
                scenarios.write('\n')
            scenarios.close()
